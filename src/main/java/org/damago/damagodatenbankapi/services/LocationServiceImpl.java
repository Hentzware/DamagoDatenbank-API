...
public class LocationServiceImpl implements LocationService {
    ...
    public LocationResponse Add(AddLocationRequest request) {
        ...
        Location location = standortRepository.sp_Locations_GetById(id);
    ...
    public LocationResponse Edit(EditLocationRequest request) {
        ...
        Location location = standortRepository.sp_Locations_GetById(request.getId());
        return modelMapper.map(location, LocationResponse.class);
    }
    ...
    public Iterable<LocationResponse> Get(boolean deleted) {
        ...
        if (deleted) {
            locations = standortRepository.sp_Locations_GetDeleted();
        } else {
            locations = standortRepository.sp_Locations_Get();
        }
    ...
    public Iterable<LocationResponse> Search(SearchLocationRequest request) {
        Iterable<Location> standorte = standortRepository.sp_Locations_Search(request.getName());
